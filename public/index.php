...
$router->get('/entreprises/evaluer', 'App\\Controllers\\StudentController@companyReview');
$router->post('/entreprises/evaluer', 'App\\Controllers\\StudentController@storeCompanyReview');
...
$router->get('/pilote/offres', 'App\\Controllers\\PilotController@offers');
$router->post('/pilote/offres', 'App\\Controllers\\PilotController@saveOffer');
$router->post('/pilote/offres/supprimer', 'App\\Controllers\\PilotController@deleteOffer');
...
$router->post('/pilote/entreprises', 'App\\Controllers\\PilotController@saveCompany');
$router->post('/pilote/entreprises/supprimer', 'App\\Controllers\\PilotController@deleteCompany');
$router->get('/pilote/etudiants', 'App\\Controllers\\PilotController@students');
$router->post('/pilote/etudiants', 'App\\Controllers\\PilotController@saveStudent');
$router->post('/pilote/etudiants/supprimer', 'App\\Controllers\\PilotController@deleteStudent');
