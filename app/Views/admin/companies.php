...
<header class="page-heading">
  <div class="page-heading-block">
    ...
    <p class="page-heading-subtitle">
      Maintenez à jour les fiches partenaires et leurs informations de contact.
    </p>
  </div>
</header>
...
<section class="page-layout offer-management-layout">
  <aside class="side-card">
    ...
    <div class="side-card-links">
      ...
      <a href="<?= htmlspecialchars(\Core\Url::route('admin/offres/modifier'), ENT_QUOTES) ?>" class="management-offer-link">
        <strong>Gérer les offres</strong>
        <span>Mettre à jour les publications rattachées</span>
      </a>
    </div>
      ...
      <form method="post" action="<?= htmlspecialchars(\Core\Url::route('admin/entreprises'), ENT_QUOTES) ?>" data-js-validate>
        ...
        <div class="form-footer offer-form-actions offer-form-actions--split">
          ...
          <?php if (!$isNewCompany && (int) ($selectedCompany['id_entreprise'] ?? 0) > 0): ?>
            <button
              type="submit"
              formaction="<?= htmlspecialchars(\Core\Url::route('admin/entreprises/supprimer'), ENT_QUOTES) ?>"
              formmethod="post"
...
<section class="section">
  <div class="section-header">
    <div>
      ...
      <p class="section-subtitle">Résumé des entreprises partenaires, de leurs offres et des actions rapides.</p>
    </div>
  </div>
    ...
    <table class="data-table">
      ...
      <tbody>
        <?php foreach (($companies ?? []) as $company): ?>
          <tr>
            <td>
              <a href="<?= htmlspecialchars(\Core\Url::route('admin/entreprises?id=' . (int) $company['id_entreprise']), ENT_QUOTES) ?>">
            ...
            <td>
              <div class="table-actions">
                <a href="<?= htmlspecialchars(\Core\Url::route('admin/entreprises?id=' . (int) $company['id_entreprise']), ENT_QUOTES) ?>" class="btn btn-outline">Modifier</a>
